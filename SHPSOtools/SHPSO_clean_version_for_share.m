...
function [bestfit,hx,hf,fitcount,CE,gfs,pbest,pbestval,formula1,formula2]...
    = SHPSO_clean_version_for_share(FUN,Dimension,Particle_Number,VRmin,VRmax,pos0,e0,hx,hf,fitcount,mf,CE,sn1,gfs)
...
%     figure(1);
%     xx =  linspace(VRmin(1),VRmax(1),1000);
%     yy = [];
%     for r=1:1000
%         y = feval(fname, xx(r));
%         yy = [yy, y];
