...
mf=2000;    % maximum number of exact evaluation -----> user defined: 1000(30D,50D,100D) / 8000(30D) /
% 
sn1=1;  
...
save(strcat('result/CEC14_NFE',num2str(mf),'_',num2str(findex),' runs=',num2str(runs),' Dim=',num2str(Dim)));
end
