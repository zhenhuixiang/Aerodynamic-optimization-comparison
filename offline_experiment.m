...
runs = 30;
for i = 1:runs
    [cloriginal(i,:),clfittest(i,:),fittest(i,:)]=MSDDEOairfoil(genNo,p0,range,uinf,AOA,Npanel);
%     [cloriginal(i,:),clfittest(i,:),fittest(i,:)]=BDDEALDGairfoil(genNo,p0,range,uinf,AOA,Npanel);
%     [cloriginal(i,:),clfittest(i,:),fittest(i,:)]=MSEAairfoil(genNo,p0,range,uinf,AOA,Npanel);
