...
% [cloriginal,clfittest,fittest]=ESAOairfoil(genNo,p0,range,uinf,AOA,Npanel);
% [cloriginal,clfittest,fittest]=DESOairfoil(genNo,p0,range,uinf,AOA,Npanel);
% [cloriginal,clfittest,fittest]=SHPSOairfoil(genNo,p0,range,uinf,AOA,Npanel);
% [cloriginal,clfittest,fittest]=DEairfoil(genNo,p0,range,uinf,AOA,Npanel);
