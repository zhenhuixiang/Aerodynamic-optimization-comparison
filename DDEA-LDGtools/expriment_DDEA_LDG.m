...
funcArr={'S_ACKLEY'; 'S_GRIEWANK'; 'S_ROSENBROCK';'S_ELLIPSOID'; 'S_RASTRIGIN';  'CEC05_F10'; 'CEC05_F16';  'CEC05_F19';}; 
dimsArr = [10 30 50 100  ]; 
runs = 20;
o = length(funcArr);
d = size(dimsArr,2);
...
for i = 1:d
    ...
    for j = 1:o   
        ...
        for r = 1:runs
            ...
            Dim = length(LB);
            [time,P,gbest,predict] = DDEA_LDG(Dim,DATA,UB,LB);
        ...
        save(strcat('result/',fname,' runs=',num2str(runs),' Dim=',num2str(dims)));
    end
end